...
public class SpreedlyPaymentMethod {
    ...
    @XmlElement(name = "third_party_token")
    public String                    thirdPartyToken;
    public boolean                   test;
    @XmlElement(name = "last_four_digits")
    public String                    lastFourDigits;
    @XmlElement(name = "first_six_digits")
    ...
    @XmlElement(name = "shipping_phone_number")
    public String                    shippingPhoneNumber;
    @XmlElement(name = "full_name")
    public String                    fullName;
    @XmlElement(name = "eligible_for_card_updater")
