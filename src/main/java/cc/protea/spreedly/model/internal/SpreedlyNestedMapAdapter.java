...
/**
 * Spreedly sometimes returns an element containing (probably only one) elements that contain effectively random key/value pairs as <key>value<key>
 *     . The name of the
 * wrapping element is unknown and generally corresponds to the gateway, but new gateways may be added at any time. The data is also unknown and
